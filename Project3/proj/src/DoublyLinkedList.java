...
public class DoublyLinkedList<Item> implements Iterable<Item> {
    ...
    /**
     * @param i index of desired iterator
    ...
    private class DoublyLinkedListIterator implements ListIterator<Item> {
        ...
        public DoublyLinkedListIterator(int index)
        {
        	...
        	//find the desired starting node
        	this.current = pre;
        ...
        /**
         * @return {@code true} if there is a node following the current one
         */
        public boolean hasNext()      { return index < size(); }
        
        /**
         * @return {@code true} if there is a node preceeding the current one
         */
